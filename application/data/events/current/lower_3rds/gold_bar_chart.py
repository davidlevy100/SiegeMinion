...
from data.esports.stats import calculate_teams_gold


class GoldBarChartL3(L3Activatable):

    # Input Properties
    local_time = kp.NumericProperty(0)
    players = kp.DictProperty()

    start_time = kp.NumericProperty()
    end_time = kp.NumericProperty()
    ...
    def __init__(self, **kwargs):
        ...
        self.graphic_name = "Gold Bar Chart"
