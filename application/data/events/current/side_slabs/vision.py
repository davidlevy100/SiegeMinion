...
from data.esports.stats import calculate_vision

class VisionSideSlab(SideSlabActivatable):
    ...
    def __init__(self, **kwargs):
        ...
        self.graphic_name = "Vision Score"
    ...
    def update_properties(self, *args):
        ...
        if new_sort is not None:
            ...
            for index, this_tuple in enumerate(new_sort[::-1], 1):
                ...
                this_value.set(self, f'{this_tuple[0]:.0f}')
    ...
    def get_sort(self, *args):
        ...
        if "participants" in self.current_stats_update:
            ...
            for this_participant in self.current_stats_update["participants"]:
                ...
                if "participantID" in this_participant:

                    vision_score = calculate_vision(this_participant)

                    if vision_score is None:
                        vision_score = 0

                    new_sort.add(
                        (vision_score, this_participant["participantID"])
                    )
